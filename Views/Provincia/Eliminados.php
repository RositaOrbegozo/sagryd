                ...
                <div class="col-lg-12 mt-2">
                    <div class="row">
                        <div class="col-lg-6 mb-2">
                            <a class="btn btn-primary" href="<?php echo base_url(); ?>Provincia/Listar"><i class="fas fa-arrow-alt-circle-left"></i> Regresar</a>
                        </div>
                    </div>
                    <div class="text-center">
                        <h2> TABLA PROVINCIAS INACTIVOS </h2>
                    </div>
                        ...
                        <table class="table table-hover table-bordered text-center" id="Table">
                            ...
                            <tbody>
                                ...
                                <tr id="negro">
                                        ...
                                        <td >
                                            <form action="<?php echo base_url() ?>Provincia/reingresar?id=<?php echo $cl['id_prov']; ?>" method="post" class="d-inline confirmar">
