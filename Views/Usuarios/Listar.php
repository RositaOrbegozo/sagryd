                ...
                <div class="col-lg-12 mt-2">
                    <div class="row">
                        <div class="col-lg-6 mb-2">
                            <button class="btn btn-green" type="button" data-toggle="modal" data-target="#nuevo_cliente">Nuevo</button>
                            <a href="<?php echo base_url(); ?>/Usuarios/eliminados" class="btn btn-danger">Inactivos</a>
                            <a href="<?php echo base_url(); ?>/Usuarios/eliminados" class="btn btn-warning "><i class="fas">&#xf1c1;</i> Reporte</a>
                        </div>
                        <div class="col-lg-6">
