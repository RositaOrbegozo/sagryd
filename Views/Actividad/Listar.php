                ...
                <div class="col-lg-12 mt-2">
                    <div class="row">
                        <div class="col-lg-6 mb-2">
                            <button class="btn btn-green" type="button" data-toggle="modal" data-target="#nueva_actividad"><i class="fas fa-plus-circle"></i> Nuevo</button>
                            <a class="btn btn-danger" href="<?php echo base_url(); ?>Actividad/eliminados"><i class="fas fa-user-slash"></i> Inactivos</a>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <table class="table table-hover table-bordered text-center" id="Table">
                            <thead >
                                <tr id="blanco">
                                    ...
                                    <th width="10%" style="text-align: center">Fecha Programada</th>
                                    <th width="20%" style="text-align: center">Prioridad</th>
                            ...
                            <tbody>
                                <?php foreach ($data as $cl) { ?>
                                    <tr id="negro">
                                        ...
                                        <td><?php echo $cl['FECHA_PROGRAMADA']; ?></td>
                                        <td><?php echo $cl['PRIORIDAD_DESCRIPCION']; ?></td>
                                        <td>
                                            <a href="<?php echo base_url() ?>Actividad/editar?id=<?php echo $cl['ID_ACTIVIDAD']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                            <form action="<?php echo base_url() ?>Actividad/eliminar?id=<?php echo $cl['ID_ACTIVIDAD']; ?>" method="post" class="d-inline elim">
...
<div id="nueva_actividad" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url(); ?>Actividad/insertar" autocomplete="off">
